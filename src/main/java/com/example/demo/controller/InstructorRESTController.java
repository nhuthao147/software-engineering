...
public class InstructorRESTController {
	...
	public Instructor addInstructor(@RequestBody Instructor insForm){
		System.out.println("(Service Side) Creating instructor with instructorId: " + insForm.getInstructorId());
	...
	public Instructor updateInstructor(@RequestBody Instructor insForm){
		System.out.println("(Service Side) Editing instructor with instructorId: " + insForm.getInstructorId());
